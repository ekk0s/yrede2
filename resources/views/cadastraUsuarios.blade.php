...
<head>
    ...
    <style>
        body::after {
            content: "";
            background: url("https://wallpapers.com/images/hd/dark-mode-3840-x-2160-background-6xrac361hd277x12.jpg");
...
<body class="bg-black bg-opacity-50">
    ...
    <form class="card-body max-w-md m-auto bg-black bg-opacity-50 rounded"  action="{{route('salva-usuario')}}" method="post">
